                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" class="content" style="background-color: #FFFFFF">
                    <tbody><tr>
                        <td id="templateContainerHeader" valign="top" mc:edit="welcomeEdit-01">
                            <p style="text-align:center;margin:0;padding:0;"><img src="http://webnician.net/webnicianHub/themes/webnician/assets/images/NewWeb26.png" style="display:inline-block;"></p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="brdBottomPadd-two" id="templateContainer" width="100%">
                                <tbody><tr>
                                    <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                                        ...
                                        <h1><strong>Congratulations on registering for Evenz!</strong></h1>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tbody><tr>
                                                <td align="left" style="margin:0;padding:0;" valign="top" width="50" mc:edit="welcomeEdit-03">
                                                    <p style="margin-bottom:10px"><img src="https://avatars3.githubusercontent.com/u/7333448?s=460&v=4" style="display:block;"></p>
                                                </td>
                                                ...
                                                <td align="left" style="margin:0;padding-top:10px;line-height:1;" valign="top" mc:edit="welcomeEdit-04">
                                                    <h4><strong>Olaf Broms</strong></h4>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter" width="100%">
                                <tbody><tr>
                                    <td valign="top" width="100%" mc:edit="welcomeEdit-11">
                                        ...
                                        <h6 style="text-align:center;margin-top: 9px;">Evenz</h6>
